...
(application workspace only)""",
    ...
    'cloudwatch-setup.info': 'Create .platform files necessary for setting up '
                             'CloudWatch used in logging instance deployment.',
    'cloudwatch-setup.alreadysetup': 'CloudWatch file {filename} is already set up.',
    'cloudwatch-setup.text': '.platform created. In order to complete setup you '
                             'will need\n'
    ...
    'cloudwatch-setup.removetext': 'Removed .platform. In order to complete removal '
                                   'you\n'
...
flag_text = {
    ...
    'labs.cwl.remove': 'remove .platform',
